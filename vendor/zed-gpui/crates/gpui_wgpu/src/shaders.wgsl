...
// Binding 2 remains in the shared layout for source compatibility with the
// upstream two-plane video surface pipeline. Artist's Linux compositor exports
// one-plane XR24/AR24-family RGB DMA-BUFs, so it is intentionally unused here.
@group(1) @binding(2) var t_surface_unused: texture_2d<f32>;
