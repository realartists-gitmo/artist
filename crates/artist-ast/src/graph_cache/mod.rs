...
/// Serialize repository-wide analysis with host-side resource snapshots.
/// Standalone ast-bro APIs read the working tree themselves; embedders can
/// hold this guard while collecting their source snapshot and requesting a
/// graph so a concurrent in-process mutation cannot interleave the operation.
pub use shared::analysis_lock;
