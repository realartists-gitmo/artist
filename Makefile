...
plugin:
	...
	RUSTC_WRAPPER= cargo run -p artist-plugin --example load -- target/wasm32-wasip2/debug/artist_default_plugin.wasm target/wasm32-wasip2/debug/artist_tool_fixture.wasm target/wasm32-wasip2/debug/artist_ast_fixture.wasm

fuse-test: plugin
	RUSTC_WRAPPER= cargo run -p artist-plugin --example fabric -- target/wasm32-wasip2/debug/artist_tool_fixture.wasm target/wasm32-wasip2/debug/artist_ast_fixture.wasm
